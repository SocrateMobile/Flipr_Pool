...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    sensors_config = [
        ...
        ("sigfox_status",    "sigfox_status",    None,    None,                          "mdi:cellular-signal-3", EntityCategory.DIAGNOSTIC),
        ("resets_counter",   "resets_counter",   None,    None,                          "mdi:restart", EntityCategory.DIAGNOSTIC),
        ("last_resume_call", "last_resume_call", None,    SensorDeviceClass.TIMESTAMP,   "mdi:clock-check-outline", EntityCategory.DIAGNOSTIC),
